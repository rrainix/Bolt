...
%BGFX_PATH%\shadercRelease.exe -f %SHADER_SRC%\vs_gizmo.sc -o %SHADER_OUT%\vs_gizmoDx.bin --type vertex --platform windows -p s_5_0 -i %SHADER_SRC% --varyingdef %SHADER_SRC%\varying.def.sc
...
%BGFX_PATH%\shadercRelease.exe -f %SHADER_SRC%\fs_gizmo.sc -o %SHADER_OUT%\fs_gizmoDx.bin --type fragment --platform windows -p s_5_0 -i %SHADER_SRC% --varyingdef %SHADER_SRC%\varying.def.sc
